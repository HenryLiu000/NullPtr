...
Play1v1::Play1v1(int n,QWidget* parent):QWidget(parent),whichmode(n)
{
    //Title
    ...
    buffer[1] = new CardSlot(parent,1200,200,160,250/*,Qt::black*/);
...
void Play1v1::paintEvent(QPaintEvent *event)
{
